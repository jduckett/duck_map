...
class ActsAsSitemap01Test < ActiveSupport::TestCase
  ...
  test "class acts_as_sitemap title: :my_title" do
    ...
    class ActsAsSitemap01TestObject01
    ...
    a = ActsAsSitemap01TestObject01.new

    assert HashModel.verify("unit/sitemap/models/test01", a.sitemap_attributes_hash)
  ...
  test "object acts_as_sitemap title: :my_title" do
    ...
    assert HashModel.verify("unit/sitemap/models/test01", ActsAsSitemap01TestObject02.sitemap_attributes_hash)
